...
function App() {
  ...
  // myBoot();
  const myHMAC = "89c1f55c5135aa55d7ecfc2f2da4e0e0b6ec81ccd43a153a14350cb4cba6d96d";
  window.CommandBar.boot("lch-jun", { friend: "false" }, { hmac: myHMAC });
  ...
  const integrations = [
    {
      label: "Github",
      description: "Use this integration to connect Github and make coding even more seamless",
      id: 1,
    ...
    {
      label: "Slack",
      description: "Use this integration to connect Slack and make your chat more fun",
      id: 2,
    ...
    {
      label: "Google Drive",
      description: "Use this integration to connect GDrive and make file sharing easy as pie",
      id: 3,
  ...
  const images = [
    {
      icon: './static_assets/mark-harpur-guatemala.png',
      label: 'Guatemala',
  ...
  window.CommandBar.addRecords('images', images, { labelKey: 'label', descriptionKey: 'description' });
  ...
  // callback that interacts with a web request command
